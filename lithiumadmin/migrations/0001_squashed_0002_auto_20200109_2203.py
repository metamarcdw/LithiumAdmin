# Generated by Django 2.2.8 on 2020-01-09 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('database_type', models.CharField(blank=True, choices=[('OR', 'Oracle'), ('MS', 'SQL Server')], max_length=2)),
                ('datacenter', models.CharField(blank=True, choices=[('ONP', 'On-Premise'), ('HOS', 'Hosted'), ('SAA', 'SaaS')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='KnownBug',
